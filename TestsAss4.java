...
public class TestsAss4 {
    ...
    public void testForVal() throws Exception {
         ...
         * TODO FIX
         */
        List<String> vars = va1.getVariables();
        for (String v : vars) {
    ...
    public void testForNand() throws Exception {
        ...
        /*test getVariables*/
        System.out.println(nan1.getVariables());
    ...
    public void testForNor() throws Exception {
        ...
        System.out.println(no2.simplify().toString());
    ...
    public void testForOr() throws Exception {
        ...
        System.out.println(or8.simplify().toString());
    ...
    public void testForXnor() throws Exception {
        ...
        System.out.println(xn6.simplify().toString() + " ERROR");
        ...
        System.out.println(xn11.simplify().toString() + " ERROR");
    ...
    public void testForExpressions() throws Exception {
        ...
        System.out.println(e10.nandify().toString());
